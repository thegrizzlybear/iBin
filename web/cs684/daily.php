...
<body>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a class="active" href="daily.php">Daily Food Wastage</a>
                                </li>
                                <li>
                                    <a href="weekly.php">Weekly Food Wastage</a>
                                </li>
                                <!--li>
                            ...
                            <div class="pull-right">
                                <div class="btn-group" style="font-family: 'Trebuchet MS', 'Helvetica', 'Arial',  'Verdana', 'sans-serif';font-size: 62.5%;">
                                    ...
                                    <select name="time" id="time">
                                        <option <?php if (strcmp($time,'Breakfast')==0) echo 'selected="selected"'; else echo ''; ?> >Breakfast</option>
                                        <option <?php if (strcmp($time,'Lunch')==0) echo 'selected="selected"'; else echo ''; ?> >Lunch</option>
                                        <option <?php if (strcmp($time,'Tiffin')==0) echo 'selected="selected"'; else echo ''; ?> >Tiffin</option>
                                        <option <?php if (strcmp($time,'Dinner')==0) echo 'selected="selected"'; else echo ''; ?> >Dinner</option>
                                    </select>
    ...
    <script src="js/plugins/jquery-ui/showCal.js"></script>
    ...
    <script src="datagen/dbTest.php?date=<?php echo $date;?>&time=<?php echo $time;?>"></script>
